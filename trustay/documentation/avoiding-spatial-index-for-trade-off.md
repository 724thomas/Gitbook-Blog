...
### 4.2. 핵심 구현: "정적인 공간"과 "동적인 유저"의 분리
...
DB락을 회피하기 위해 페이징 기법, 그리고 CPU 성능 저하를 피하기 위해 커서 기반 페이징 기법을 사용했습니다.
...
#### **1. Write Performance (쓰기 성능의 완전한 방어)**
