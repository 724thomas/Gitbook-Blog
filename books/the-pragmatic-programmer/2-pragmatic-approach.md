...
**‘한 번의 변경으로 모든 곳이 바뀌는 시스템’을 만드는 사고방식**이다.\
...
> _“관련 없는 것들 간에 서로 영향을 미치지 않도록 하라.”_&#x20;
...
> _“최종 결정이란 없다. 되돌릴 수 없는 선택은 하지 마라.”_
...
> _“완벽을 목표로 하지 말고, 문제를 드러내는 데 집중하라.”_
...
> _“모델을 만들고, 실험으로 검증하라. 놀라지 않게 만드는 것이 진짜 추정이다.”_
